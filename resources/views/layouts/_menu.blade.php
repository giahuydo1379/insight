      ...
      <ul id="mainnav-menu" class="list-group">
        ...
        <li
          ...
          <ul class="collapse">
            ...
            <li class="<?= (\Request::is('authorized/show-role')) ? 'active-link' : ''; ?>"><a
                 href="{{ url('/authorized/show-role') }}">Cấp độ truy cập</a></li>
            <li class="<?= (\Request::is('authorized/show-permission')) ? 'active-link' : ''; ?>"><a
                      href="{{ url('/authorized/show-permission') }}">Quyền</a></li>
          </ul>
        </li>
        @endrole
