...
<div id="container" class="cls-container">
  ...
  <div class="demo-bg">
    <div id="demo-bg-list">
      ...
      <img class="demo-chg-bg bg-trans active" src="/public/assets/img/bg-img/thumbs/bg-trns.jpg" alt="Background Image">
...
<script src="/public/assets/js/demo/bg-images.js"></script>
