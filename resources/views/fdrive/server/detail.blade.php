...
<link href="/public/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.min.css" rel="stylesheet">
                ...
                <div class="fixed-fluid">
                    <div class="fixed-md-200 pull-sm-left fixed-right-border">
                        ...
                        <div class="text-center">
                            ...
                            <div class="pad-ver">
                                <img src="/images/ubuntu.png" class="img-lg img-circle" alt="Profile Picture">
                            </div>
                    ...
                    <div class="fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <a class="btn btn-success btn-labeled" href=" {{ url('/fdrive/customer/')}}/{{$data['user_id']}}"><i class="btn-label fa fa-th-large"></i> Xem chi tiết</a>
                            </div>
                        </div>
                        <hr class="new-section-xs">
...
<!--Switchery [ OPTIONAL ]-->
<script src="/public/assets/plugins/switchery/switchery.min.js"></script>
